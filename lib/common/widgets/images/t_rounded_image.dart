...
class TRoundedImage extends StatelessWidget {
  const TRoundedImage({
    ...
    this.customBorderRadius, // تم إضافته هنا كمعامل اختياري
  });
  ...
  customBorderRadius; // يتيح تحديد الاتجاه والقيمة معاً
  final BoxFit? fit;
  final String? image;
  final File? file;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        // التحقق: إذا كان مخصصاً نستخدمه، وإلا ننشئ دائري بناءً على الـ double
